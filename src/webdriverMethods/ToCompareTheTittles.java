...
public class ToCompareTheTittles {
	public static void main(String[] args) throws InterruptedException {
		...
		String expectedTittle = "vivo Smartphones, Earphones, Wearables & Accessories | vivo India";
		String Actualtitte = driver.getTitle();
		if (expectedTittle.equals(Actualtitte)) {
			driver.manage().window().fullscreen();
			Thread.sleep(5000);
		}
		driver.quit();
